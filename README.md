To run this, you need to install Flask (pip install Flask) and PyJWT (pip install PyJWT). Then, save this code in a file (app.py) and run it using python app.py. The server will start running on port 8080.
